    ...
    <AuthLayout showcase={<ShowcaseLogin />}>
      <div className="flex flex-col space-y-6">
        ...
        <form className="space-y-5 pt-4">
          ...
          <div className="flex items-center space-x-3 py-2">
            <div className="relative flex items-center justify-center">
              ...
              />
              <div className="w-5 h-5 rounded border border-border/50 bg-input/20 peer-checked:bg-primary peer-checked:border-primary transition-colors flex items-center justify-center">
          ...
          <Button type="button" className="w-full h-12 rounded-xl text-md font-semibold mt-2 bg-primary hover:bg-primary/90 text-white">
            Log in
        ...
        <div className="grid grid-cols-2 gap-4">
          <Button variant="outline" type="button" className="h-12 rounded-xl border-white/10 bg-white/5 hover:bg-white/10 hover:border-white/20 font-semibold text-xs sm:text-sm transition-all duration-200">
