...
const FAQS = [
  ...
  },
  {
    ...
    a: "Alert: sends an email (and Slack on Plus+) when your spend crosses the threshold — no key is disabled. Block: marks the connection as blocked at the next poll cycle, preventing further usage until you re-enable it. Throttle (Pro only): reduces polling priority rather than hard-blocking, giving you a softer response for non-critical connections.",
  },
  {
    q: "What is the difference between Plus and Pro?",
    a: "Plus gives you 3 connections, 5 projects, 90-day history, Slack alerts, and budget rules (alert + block). Pro adds unlimited connections and projects, 1-year history, webhook alerts, per-user cost attribution (track which of your end-users costs what), and programmatic API access.",
  },
  {
