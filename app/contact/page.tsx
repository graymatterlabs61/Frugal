...
export const metadata: Metadata = {
  ...
  description:
    "Have questions about Frugal AI API cost management? Reach out to our team at support@frugal.so — we respond within 24 hours.",
  alternates: { canonical: "https://frugal.so/contact" },
  openGraph: {
    title: "Contact Frugal — Get in Touch",
    description: "Have questions about Frugal? Reach out to our team — we respond within 24 hours.",
    url: "https://frugal.so/contact",
  },
}
...
const CHANNELS: Channel[] = [
  {
    ...
    label: "Support",
    value: "support@frugal.so",
    href: "mailto:support@frugal.so",
  ...
  },
  {
    ...
    label: "Feedback",
    value: "feedback@frugal.so",
    href: "mailto:feedback@frugal.so",
  ...
  return (
    ...
    >
      ...
      <LegalSection id="response-times" num={2} title="Response Times">
        ...
        >
          Enterprise plan customers get a dedicated Slack channel and a guaranteed 4-hour response
          SLA on business days. Contact us to discuss enterprise pricing.
        </LegalCard>
      </LegalSection>
      ...
      <LegalSection id="faq" num={3} title="Quick Answers">
        ...
        <p>
          Yes. The free tier covers basic monitoring for one provider. Paid plans unlock
          multi-provider support, advanced budget rules, Slack alerts, and team features.
        </p>
        ...
        <p>
          ...
          <a href="mailto:support@frugal.so" className="text-primary hover:underline">
            support@frugal.so
          </a>{" "}
