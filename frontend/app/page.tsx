...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "1. Connect your OpenAI API key to Frugal. 2. Navigate to Budget Rules. 3. Create a rule with your limit amount and choose the Block action. Frugal acts at the next 5-minute poll — pair it with OpenAI's native hard limit for a guaranteed stop.",
      },
    },
    {
      "@type": "Question",
  ...
  return (
    <div className="bg-background text-foreground relative z-0">
      ...
      <main>
        ...
        <HowItWorks />
        <UseCases />
        <PricingTeaser plans={plans.personal} />
        <FaqSection />
        <FinalCTA />
      </main>
      <Footer />
