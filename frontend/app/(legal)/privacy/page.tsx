...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://getfrugal.dev/privacy" },
}
    ...
    >
      ...
      <LegalSection id="data-usage" num={3} title="How We Use Your Data">
        <LegalList>
          ...
          <li>
            To send product and launch updates (you can unsubscribe at any
            time).
          </li>
      ...
      <LegalSection id="retention" num={6} title="Data Retention">
        ...
        <p>
          Marketing email addresses are retained until you unsubscribe or
          request deletion.
        </p>
      </LegalSection>
