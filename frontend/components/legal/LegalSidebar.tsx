...
export function LegalSidebar({ sections, variant = "legal" }: SidebarProps) {
  ...
  return (
    <aside className="sticky top-16 flex h-fit w-full flex-col gap-10 md:w-64 shrink-0">
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? "bg-gradient-to-r from-primary/[0.13] to-transparent text-primary font-medium ring-1 ring-primary/20 shadow-[0_0_16px_#FF500B1A]"
      ...
      <div className="rounded-2xl border border-white/[0.08] bg-gradient-to-br from-white/[0.04] to-transparent p-5 shadow-sm ring-inset-glow">
        ...
        <a
          href="mailto:legal@getfrugal.dev"
