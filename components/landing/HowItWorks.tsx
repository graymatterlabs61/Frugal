...
const steps = [
  {
    ...
    body: "Paste API keys. Frugal validates and starts tracking immediately — keys encrypted with AES-256 before touching the database.",
  },
  {
    num: "02",
    Icon: SlidersHorizontalIcon,
    title: "Set budget rules",
    body: "Monthly limits per provider. Alert at 80%, 90%, 100% — or any threshold you choose. Per-project and per-team support.",
  },
  {
    num: "03",
    Icon: BellRingingIcon,
    title: "Get alerts, not invoices",
    body: "Frugal polls every 5 minutes. Slack and email fire the moment you cross a threshold — before the damage is done.",
  },
]
