...
export function FinalCTA() {
  return (
    <section id="waitlist" className="glass-panel backdrop-blur-md w-full grid grid-cols-1 md:grid-cols-3 my-20 md:my-40 justify-start relative z-20 max-w-7xl mx-auto rounded-3xl overflow-hidden">
      <div
      ...
      <div className="md:col-span-2 p-8 md:p-14">
        <h2 className="text-left text-neutral-500 dark:text-neutral-200 text-xl md:text-3xl tracking-tight font-medium">
          Take control of your <span className="font-bold text-black dark:text-white">AI costs</span> today.
        </h2>
