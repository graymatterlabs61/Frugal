...
const initialNotifications: Notification[] = [
  {
    ...
    description: "OpenAI project hit 80% of monthly limit ($40 of $50)",
    time: "2m ago",
    read: false,
    href: "/alerts",
  },
  {
    ...
    description: "Anthropic API key validation failed — key may be expired",
    time: "1h ago",
    read: false,
    href: "/connections",
  },
  {
    ...
    type: "success",
    title: "Usage synced",
    description: "All providers polled successfully",
    time: "5h ago",
    read: true,
  },
];
...
export function Header({ onMenuClick }: HeaderProps) {
  ...
  return (
    <header className="h-16 border-b border-border flex items-center px-5 gap-4 bg-background/95 backdrop-blur-sm sticky top-0 z-40">
      <Button
        variant="ghost"
        size="icon"
