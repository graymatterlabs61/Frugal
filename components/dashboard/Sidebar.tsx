...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/help", icon: InfoIcon, label: "Help & Support" },
    ],
  },
];
      ...
      <div className="border-t border-border shrink-0 p-3">
        <Popover open={userMenuOpen} onOpenChange={setUserMenuOpen}>
          <PopoverTrigger asChild>
            <button
              className={cn(
                "w-full rounded-xl bg-accent/50 border border-border/50 hover:bg-accent hover:border-border transition-all",
                isCollapsed
          ...
          >
            ...
            <button
              disabled
              className="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm w-full text-left text-muted-foreground/50 cursor-default"
            >
              <CrownIcon size={15} className="text-muted-foreground/40 shrink-0" />
              <span>Upgrade to pro</span>
              <span className="ml-auto text-[9px] font-bold uppercase tracking-wider bg-muted text-muted-foreground/50 rounded px-1.5 py-0.5">
                Soon
              </span>
            </button>
